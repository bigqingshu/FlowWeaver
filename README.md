...
- 下一步建议进入 P.4：clean-room 解压 smoke，使用 P.3 生成的 zip 和 `.sha256` 解压到仓库外、包含空格和中文的路径，验证 backend-only 启动、health、token 鉴权和首次 runtime 生成
