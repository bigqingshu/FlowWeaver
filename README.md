...
- 下一步建议进入 N.5 便携目录后端完整 runtime smoke：使用 `.tmp/FlowWeaverPortable/EngineHost/python312/python.exe` 从便携目录启动后端，验证 workflow、run、NodeRun、RuntimeEvent REST、TableRef、SharedPublication 和 AuditEvent，不启动 Avalonia UI
