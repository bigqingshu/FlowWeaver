...
- 下一步建议进入 N.9 Desktop 发布产物最小 workflow run 事件联调 smoke：继续不启动可视化窗口，加载发布目录 API/WebSocket Client，启动最小 workflow run 并验证 `WORKFLOW_STARTED` / `WORKFLOW_FINISHED`
