...
- 下一步建议进入 P.7：阶段 P 总体验收复核，统一复核 P.1-P.6 的归档、runtime audit、manifest/hash/license、clean-room smoke、用户手册和未进入范围
