...
- 下一步建议进入 N.8 Desktop 发布产物 RuntimeEvent WebSocket Client 前置 smoke：继续不启动可视化窗口，加载发布目录 WebSocket Client，连接便携 EngineHost 并验证 `ENGINE_READY`
