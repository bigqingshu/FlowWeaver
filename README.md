...
- 下一步建议进入 O.7 Desktop 启动 helper 与假 Desktop 进程验收：先用可控假进程验证 launcher 生命周期和日志边界，不修改 `start_flowweaver.cmd` 默认参数，不打开真实 Avalonia 窗口
