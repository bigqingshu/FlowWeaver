...
- 下一步建议进入 O.5 生成器接入：让便携目录自动包含 `portable_launcher.py` 和 Windows `start_flowweaver.cmd`，并更新便携 README；真实 Desktop 自动启动建议继续后置到 O.6
