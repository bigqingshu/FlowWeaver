...
- 下一步建议进入 N.6 Avalonia `dotnet publish` 与 Desktop 产物 smoke：先发布到 `.tmp/FlowWeaverPortable/Desktop/` 并验证文件级产物，不启动 UI、不让 UI 托管后端
