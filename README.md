...
- 下一步建议进入 O.1 便携组合启动脚本最小实现方案：先确认采用 PowerShell、Python 或双脚本，脚本生成位置、`--port` / `--no-desktop` 选项、Desktop 退出后是否停止 EngineHost，以及 smoke 测试方式
